...
class Frac {
 ...
 public:
  ...
  friend const Frac operator-(const Frac& t, const Frac& s) { return t + (-s); }
  friend const Frac operator*(const Frac& t, const Frac& s) {
    auto ans = t;
    ans.num *= s.num;
    ans.den *= s.den;
  ...
  friend Frac& operator+=(Frac& t, const Frac& s) { return t = t + s; }
  friend Frac& operator-=(Frac& t, const Frac& s) { return t = t - s; }
  friend Frac& operator*=(Frac& t, const Frac& s) { return t = t * s; }
  friend Frac& operator/=(Frac& t, const Frac& s) { return t = t / s; }
  ...
  friend bool operator>(const Frac& t, const Frac& s) { return s < t; }
  friend bool operator==(const Frac& t, const Frac& s) {
    return t.num == s.num && t.den == s.den;
  }
  friend bool operator!=(const Frac& t, const Frac& s) { return !(t == s); }
  friend bool operator<=(const Frac& t, const Frac& s) {
    return t < s || t == s;
  }
  friend bool operator>=(const Frac& t, const Frac& s) {
